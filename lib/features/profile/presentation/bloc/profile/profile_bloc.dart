...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ...
  ProfileBloc(this.updateUserInfo, this.updateAvatar)
  ...
  Stream<ProfileState> mapEventToState(ProfileEvent event) async* {
    if (event is UpdateUserInfoEvent) {
      ...
      var success = await updateUserInfo(UpdateUserInfoParams(
          firstName: event.firstName, lastName: event.lastName));
      yield success.fold((failure) => errorCheck(failure), (promos) {
