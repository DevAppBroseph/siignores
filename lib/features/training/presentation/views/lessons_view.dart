...
class LessonsView extends StatelessWidget {
  ...
  final int courseId;
  LessonsView({required this.moduleEntity, required this.courseId});
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: BackAppbarBtn(
          onTap: () => context.read<MainScreenBloc>().add(ChangeViewEvent(widget: TrainingView(courseId: courseId,))),
        )
      ),
          ...
          if(state is GotSuccessLessonsState){
            if(bloc.lessons.isEmpty){
              return Column(
                ...
                children: [
                  Text('Пока нет уроков', style: MainConfigApp.app.isSiignores
