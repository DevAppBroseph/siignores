  ...
  void saveTap(BuildContext context) {
    if (formKey.currentState!.validate()) {
      if (passwordFirstController.text.trim() !=
        ...
        context.read<RegisterBloc>().add(RegisterSetPasswordEvent(
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          shadowColor: MainConfigApp.app.isSiignores
              ? ColorStyles.black
              : ColorStyles.white,
          title: const Text('Установка пароля'),
      ...
      floatingActionButton:
          PrimaryBtn(title: 'Сохранить', onTap: () => saveTap(context)),
