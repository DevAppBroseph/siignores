...
class _ForgotPasswordViewState extends State<ForgotPasswordView> {
  ...
  void onTap(BuildContext context){
    ...
    }else if(context.read<ForgotPasswordBloc>().currentStage == CurrentStage.second){
      if(formKey2.currentState!.validate()){
        showLoaderWrapper(context);
        context.read<ForgotPasswordBloc>().add(FPVerifyCodeEvent(
            ...
            return Column(
              ...
              children: [
                Padding(
                  ...
                  child: TopStageWidget(currentStage: context.read<ForgotPasswordBloc>().currentStage,)
                ),
                Padding(
