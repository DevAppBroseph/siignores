                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: MainConfigApp.app.isSiignores
                            ...
                            : ColorStyles.backgroundColor,
                        borderRadius:
                            const BorderRadius.all(Radius.elliptical(130, 50)),
                      ),
                    )),
                Column(
                  ...
                  children: [
                    ...
                    TopInfoHome(
                      onTapByName: () {
                        context
                            .read<MainScreenBloc>()
                            .add(ChangeViewEvent(widget: ProfileView()));
                      },
                    ),
                    SizedBox(
                      height: 28.h,
                    ...
                    SizedBox(
                        height: MainConfigApp.app.isSiignores ? 120.h : 120.h,
                          ...
                          builder: (context, state) {
                            if (state is OffersInitialState ||
                              ...
                              return ListView(
                                  ...
                                  children: [1, 2, 3, 4]
                                      .map((e) =>
                                          LectureLoadingCard(isFirst: e == 1))
                                      .toList());
                            }
                            if (state is GotSuccessOffersState) {
                              if (offersBloc.offers.isEmpty) {
                                return Container(
                                  ...
                                  margin:
                                      EdgeInsets.only(right: 23.w, left: 23.w),
                                  decoration: BoxDecoration(
                                      color: MainConfigApp.app.isSiignores
                                          ? ColorStyles.backgroundColor
                            ...
                            return MainConfigApp.app.isSiignores
                                ? ListView(
                                    scrollDirection: Axis.horizontal,
                                    children: offersBloc.offers
                                        .map(
                                          (offer) => LectureCard(
                                            width: 212.w,
                                            height: 120.h,
                                            onTap: () => showModalLecture(
                                                context, offer),
                                            offerEntity: offer,
                                            isFirst: offersBloc.offers
                                                    .indexOf(offer) ==
                                                0,
                                          ),
                                        )
                                ...
                                : LectureCard(
                                    ...
                                    height: 120.h,
                                    onTap: () => showModalLecture(
                                        context, offersBloc.offers.first),
                                    offerEntity: offersBloc.offers.first,
                                    isFirst: offersBloc.offers
                                            .indexOf(offersBloc.offers.first) ==
                                        0,
                                  );
                          },
                        )),
                ...
                builder: (context, state) {
                  ...
                  return Column(
                    children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                context.read<MainScreenBloc>().add(
                                    ChangeViewEvent(widget: CalendarView()));
                              },
                              child: Text(
                                MainConfigApp.app.isSiignores
                                    ? 'Календарь'
                                    : 'Календарь'.toUpperCase(),
                                style: MainConfigApp.app.isSiignores
                        ...
                        child: TableCalendar<CalendarEntity>(
                          ...
                          calendarStyle: CalendarStyle(
                            ...
                            todayTextStyle: MainConfigApp.app.isSiignores
                                ...
                                : TextStyles.white_13_w400.copyWith(
                                    fontFamily: MainConfigApp.fontFamily4,
                                  ),
                            ...
                            selectedDecoration: BoxDecoration(
                              color: MainConfigApp.app.isSiignores
                                  ? ColorStyles.backgroundColor
                                  : ColorStyles.lilac.withOpacity(0.6),
                              shape: BoxShape.circle,
                            ),
                          ),
                      ...
                      if (calendarBloc.tasks.any(
                        (element) => isSameDay(element.dateTime, _selectedDay),
                      ))
                        ...calendarBloc.tasks
                            .where(
                              (element) =>
