            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(
                      MainConfigApp.app.isSiignores ? 30.h : 8.h)),
              child: Row(
                children: [
                  SizedBox(
                    width: 33.h,
                    ...
                    if (bloc.notifications.isNotEmpty)
                      Positioned(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              '${bloc.notifications.length}',
                              style: MainConfigApp.app.isSiignores
                                  ? TextStyles.white_11_w700
                                  : TextStyles.white_11_w700.copyWith(
    ...
    return ClipRRect(
      ...
      child: Container(
          ...
          child: Column(
              ...
              children: notificationsBloc!.notifications
                  .map((not) => Container(
                        ...
                        decoration: BoxDecoration(
                            border: Border(
                                bottom: BorderSide(
                                    width: 1.h,
                                    color:
                                        ColorStyles.black.withOpacity(0.15)))),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(
