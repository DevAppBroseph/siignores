...
class ColorStyles {
  static Color primary = MainConfigApp.app.isSiignores
      ? const Color(0xFFD4CBC4)
      : const Color(0xFFF4CD7B);
  static MaterialColor primarySwath = MainConfigApp.app.isSiignores
      ? const MaterialColor(0xFFD4CBC4, color)
      : const MaterialColor(0xFFF4CD7B, color2);
  ...
  static Color backgroundColor = MainConfigApp.app.isSiignores
