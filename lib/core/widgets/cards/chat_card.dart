  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        crossAxisAlignment:
            centerButton ? CrossAxisAlignment.center : CrossAxisAlignment.start,
        children: [
          Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: MainConfigApp.app.isSiignores
                        ? ColorStyles.greyf9f9
                        : ColorStyles.white),
                alignment: Alignment.center,
                padding: EdgeInsets.symmetric(horizontal: 8.w),
                child: Text(
                  chatTabEntity.usersCount.toString(),
                  style: MainConfigApp.app.isSiignores
                      ? TextStyles.green_12_w700
                      : TextStyles.black_12_w700
                          .copyWith(fontFamily: MainConfigApp.fontFamily4),
                ),
              )
            ],
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(
                      MainConfigApp.app.isSiignores ? 26.w : 8.w)),
              child: Text(
